...
class JVMPlatform : Platform {
    ...
    companion object {
        ...
        private val firestore = lazy { lazyInitializeFirestore() }

        private val fileStorage =
            FileStorage(File(System.getProperty("user.home"), ".welk/firebase"))
                ...
                Firebase.initialize(
                    ...
                    options =
                        FirebaseOptions(
                            ...
                            storageBucket =
                                firebaseProperties.getProperty("firebase.storageBucket"),
                            gcmSenderId =
                                firebaseProperties.getProperty("firebase.messagingSenderId"),
                            applicationId =
    ...
    override fun initializeFirestore(): FirebaseFirestore = firestore.value
}
